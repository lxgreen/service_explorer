...
def main():
    ...
    parser.add_argument('--port', dest='port', type=int, default=8888, help='server port number (default: 8888)')
    parser.add_argument('--ip', dest='ip', type=str, default="127.0.0.1", help='server IP address (default: 127.0.0.1)')
    ...
    if client:
        print("Welcome to Service Explorer Client\n"
              "Server URL: {0}".format(client.configuration.server_url))
        while True:
            action = raw_input("\nSelect an action:\n"
